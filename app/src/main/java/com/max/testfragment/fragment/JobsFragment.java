 ...
 */
public class JobsFragment extends Fragment implements ViewPager.OnPageChangeListener, View.OnClickListener {

    private View mRootView;
    private static JobsFragment fragment;
    ...
    synchronized public static JobsFragment getInstance() {
        if(fragment == null){
